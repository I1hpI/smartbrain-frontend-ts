...
// onclick will update the state for the name to the given input
  onNameChange = (event:React.FormEvent<HTMLInputElement>) => {
    this.setState({name: event.currentTarget.value})
  }
// onclick will update the state for the email to the given input
  onEmailChange = (event:React.FormEvent<HTMLInputElement>) => {
    this.setState({email: event.currentTarget.value})
  }
// onclick will update the state for the password to the given input
